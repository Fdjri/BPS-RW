...
class BelumVerifikasiPage extends StatefulWidget {
  ...
  static const String routeName = '/checklist-belum-verifikasi';

  @override
  State<BelumVerifikasiPage> createState() => _BelumVerifikasiPageState();
}
            ...
            children: [
              Row(
                children: [
                  ...
                  Icon(LucideIcons.clock, color: AppColors.white.normal, size: 22),
